...
// Polygon counts boosted ~25x total on the viewmodel weapons.
function buildPlumbusModel() {
  const g = new THREE.Group();
  const handle = new THREE.Mesh(new THREE.CylinderGeometry(0.06, 0.06, 0.45, 49, 9), new THREE.MeshLambertMaterial({ color: 0x8a5a3a }));
  handle.position.set(0, -0.05, 0);
  const body = new THREE.Mesh(new THREE.CapsuleGeometry(0.08, 0.18, 18, 40), new THREE.MeshLambertMaterial({ color: 0xc77f6c, flatShading: true }));
  body.position.set(0, 0.18, 0);
  const knob = new THREE.Mesh(new THREE.SphereGeometry(0.07, 49, 40), new THREE.MeshLambertMaterial({ color: 0x9c5544 }));
  knob.position.set(0, 0.35, 0);
  const hand = new THREE.Mesh(new THREE.SphereGeometry(0.1, 49, 40), new THREE.MeshLambertMaterial({ color: 0xfdd6b5 }));
...
function buildPlasmaRifleModel() {
  const g = new THREE.Group();
  const stock = new THREE.Mesh(new THREE.BoxGeometry(0.1, 0.12, 0.5, 7, 7, 14), new THREE.MeshLambertMaterial({ color: 0x444455 }));
  stock.position.set(0, -0.05, -0.05);
  const barrel = new THREE.Mesh(new THREE.CylinderGeometry(0.04, 0.05, 0.55, 49, 9), new THREE.MeshLambertMaterial({ color: 0x666677 }));
  barrel.rotation.x = Math.PI / 2;
  barrel.position.set(0.02, 0.0, 0.32);
  const tip = new THREE.Mesh(new THREE.CylinderGeometry(0.07, 0.05, 0.08, 49, 5), new THREE.MeshBasicMaterial({ color: 0x97ce4c }));
  tip.rotation.x = Math.PI / 2;
  tip.position.set(0.02, 0.0, 0.6);
  const grip = new THREE.Mesh(new THREE.BoxGeometry(0.08, 0.18, 0.1, 7, 9, 7), new THREE.MeshLambertMaterial({ color: 0x222233 }));
